...
export const metadata: Metadata = {
  title: "Sign Up",
  description: "Create your TheStoryMama account",
};
      ...
      <Card className="w-full max-w-md border-0 shadow-lg">
        <CardContent className="p-8">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[var(--color-pastel-mint)] mb-3">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Create an account to start making personalized stories
            </p>
          </div>
