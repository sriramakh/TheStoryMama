  ...
  return (
    <Link href={`/stories/${story.id}`}>
      <Card className="group cursor-pointer border-0 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden h-full">
        {coverUrl ? (
          <div className="aspect-[25/24] bg-[var(--color-pastel-cream)] flex items-center justify-center">
            <img
              src={coverUrl}
          ...
          <div className="bg-[var(--color-pastel-cream)] aspect-[25/24] flex items-center justify-center">
